...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
    ...
    PeriphClkInit->PLLI2S.PLLI2SQ = (uint32_t) ((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SQ)
    ...
    PeriphClkInit->PLLSAI.PLLSAIM = (uint32_t) ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIM)
            >> RCC_PLLSAICFGR_PLLSAIM_Pos);
    PeriphClkInit->PLLSAI.PLLSAIN = (uint32_t) ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIN)
    ...
    PeriphClkInit->PLLSAI.PLLSAIQ = (uint32_t) ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ)
            ...
            switch (srcclk) {
                ...
                case RCC_I2SAPB1CLKSOURCE_PLLR: {
                    ...
                    vcooutput = (uint32_t) (vcoinput *
                                            (((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> 6U) & (RCC_PLLCFGR_PLLN >> 6U)));
...
HAL_StatusTypeDef HAL_RCC_DeInit(void) {
    ...
    RCC->PLLI2SCFGR =
            RCC_PLLI2SCFGR_PLLI2SM_4 | RCC_PLLI2SCFGR_PLLI2SN_6 | RCC_PLLI2SCFGR_PLLI2SN_7 | RCC_PLLI2SCFGR_PLLI2SQ_2 |
